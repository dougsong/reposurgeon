...
Do not genarate .gitignore files from svn:ignore properties.

--preserve::
When a branch or tag was deleted in SVN, preserve the history up to
deletion in a git ref under refs/deleted/.
...
thast the repository users want the (presumably more up-to-date)
