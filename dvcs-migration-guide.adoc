...
in bothbthe commit comment and attribution parts.  You eyeball those
to fgure out whatvthe encoding is and apply the transcode command
to fix things,
...
Repository head::
    Add transcoding to UTF-8 as a step.
