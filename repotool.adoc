...
history model, it is possible to specify both a branch specification
and a revision too get the contents of the branch as seen from a given
revision. With git checkouts, the -r, -t, and -b options are essentially
