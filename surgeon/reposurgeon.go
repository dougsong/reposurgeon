...
func (sp *StreamParser) svnProcess(options stringSet, baton *Baton) {
	...
	logit(logEXTRACT, "Phase 7: de-junking")
	baton.twirl("7")
	...
	logit(logEXTRACT, "Phase 8: tagification")
	baton.twirl("8")
	...
	logit(logEXTRACT, "Phase B: remove duplicate parent marks")
	baton.twirl("B")
	...
	logit(logEXTRACT, "Phase C: renumber")
	baton.twirl("C")
