...
Commit comments and attributions containing non-UTF8 data:: You could
    have metadata in your repository in an encoding incompatible with
    UTF-8 (Latin-1 is the most common offender). You will probably
    want to transcode the repo to UTF-8.
...
A stallout is difficult to troubleshoot than an OOM, and more likely
