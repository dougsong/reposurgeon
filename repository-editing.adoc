...
2. Use repobench to see if you can identify a revision that triggers
   ...
   readlimit up from zero intill you see the runtime spike.

3. As always, provide a stripped version of the repository for testing.
...
bug, please send te maintainers:
