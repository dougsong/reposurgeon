...
Fully automated converters are very poor at dealing with the
ontological mismatches between version-control systems; they tend to
produce crude, jackleg, unidiomatic conversion that make the seam
between the pre-conversion and post-conversion parts of the repository
very obvious. On the other hand, a skilled operator of reposurgeon can
produce a conversion that is fully idiomatic in the farget system,
greatly lowering future friction cost for developers browsing the
history.

Another application is when code needs to be removed from a repository
from repositories for legal or policy reasons.
...
kind of friction cost that sounds minor until te first time it blows
...
conversion down right is a way of controlling your downside risk.
