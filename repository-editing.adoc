= Repository Editing With Reposurgeon =
:doctype: book
...
--------
# Load the project iinto main memory
...
# tools don't need that marker. This clutter can bw tossed.
tag /-root$/ delete
...
lowering future friction cost for developers browsing the history.
...
It is good practice to include a generated tag at the
