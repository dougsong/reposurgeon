...
branchreplace.svn::
   BUG: needs analysis. Used in a repocutter test test. Derived 
   from references.svn.
...
vanilla.svn::
   Translation is orrect.  Has an enptycommit, and there's a messqge
   due to a peroperty setting. Used in repocutter and repotool tests.
